...
A device-free motion detection prototype using Wi-Fi Channel State Information (CSI) collected between two ESP32-S3 microcontrollers communicating over ESP-NOW (WIfI-protocol). No training data required. No cameras.
